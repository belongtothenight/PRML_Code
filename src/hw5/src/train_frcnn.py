...
parser.add_option("-p", "--path", dest="train_path", help="Path to training data.", default=config.annotate_output)
...
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.", default=config.train_result_model)
